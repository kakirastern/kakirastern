...
My name is Kris Stern and I am a Software Engineer/Developer currently based out in Hong Kong SAR, China. I am interested in physics, astrophysics, quantitative finance, and computer science as academic subjects, and would like to apply artificial intelligence / machine learning / algorithm to such studies, whether it is related to work or for private interest. I am also fascinated by data visualisation, especially in the exploratory analysis performed on data cubes of many dimensions. 
...
![](https://img.shields.io/badge/Code-C++/C_sharp-informational?style=flat&logo=data:image/svg%2bxml;base64,<BASE64_DATA>)
...
I maintain a blog at [Medium](https://medium.com/@krisastern), where for the moment I am using it chiefly for satisfying Google Summer of Code (GSoC) requirements. 

## 🙎🏻 Social Media

I can also be found on Twitter [![Twitter][1.2]][1] or on LinkedIn [![LinkedIn][2.2]][2].
